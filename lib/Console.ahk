/*
	Tested On		Autohotkey_L version  1.1.28.2 Unicode
...
class Console {
	...
	VarCapacity := (1024 * 8) * 1 ; 1 mb capacity
	__Version := "1.1"

	__New(TargetPID = -1, Title := "") {
